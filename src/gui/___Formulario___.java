...
public class ___Formulario___ extends JFrame implements ActionListener {
	...
	private ___Solucion____ as = new ___Solucion____();
	...
	protected void do_btn00_actionPerformed(ActionEvent e) {
		imprimir("El Precio Promedio :" +as.promedio());
		imprimir("El Precio Mayor :" +as.precioMayor());
		imprimir("El Precio Menor :"+as.precioMenor());
		imprimir("Cantidad Mayores Al Precio Promedio :"+as.superioresAlPromedio());
		imprimir("Cantidad Menores Al Precio Promedio :"+as.menoresAlPromedio());
		imprimir("Posicion del Primer Mayor Al Minimo :"+as.primerPrecioMayorAlMinimo());
		imprimir("Posicion del Ultimo Menor Al Minimo :"+as.ultimoPrecioMenorAlMinimo());
	}
}